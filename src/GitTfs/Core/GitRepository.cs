...
namespace GitTfs.Core
{
    public class GitRepository : GitHelpers, IGitRepository
    {
        ...
        public string CommitGitIgnore(string pathToGitIgnoreFile, string branchName)
        {
            ...
            if (_repository.Head.CanonicalName != branchRef && !_repository.Refs.Any(r => string.Equals(r.CanonicalName, _repository.Head.CanonicalName, StringComparison.Ordinal)))
